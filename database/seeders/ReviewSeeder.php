    ...
    public function run(): void
    {
        ...
        $reviews = [
            [
                ...
                'location' => 'ঢাকা',
                'initial' => 'রহ',
                'text' => 'অ্যারোমা ব্লেন্ড চা সত্যিই অসাধারণ! স্বাদ আর গন্ধ দুটোই প্রিমিয়াম।',
                'stars' => 5,
                'status' => true,
            ],
            [
            ...
            [
                ...
                'location' => 'সিলেট',
                'initial' => 'কা',
                'text' => 'দীর্ঘদিন ধরে ভালো চা খুঁজছিলাম। অ্যারোমা ব্লেন্ড সেই খোঁজ শেষ করেছে।',
                'stars' => 5,
                'status' => true,
            ],
            [
            ...
            [
                ...
                'location' => 'কক্সবাজার',
                'initial' => 'সো',
                'text' => 'সারাদিনে ৩ কাপ চা খাই। অ্যারোমা ব্লেন্ড স্বাস্থ্যের জন্য ভালো।',
                'stars' => 4,
                'status' => true,
            ],
            [
