...
@section('title', 'Edit Payment Method | Aroma Blend Admin')

@section('content')
<div class="container-fluid">
    <div class="page-title-head d-flex align-items-center mb-3">
        <div class="flex-grow-1">
            <h4 class="page-main-title m-0">Edit Payment Method: {{ $paymentMethod->name }}</h4>
        </div>
        <div>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('admin.ecommerce.payment-methods.update', $paymentMethod) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror"
                               value="{{ old('name', $paymentMethod->name) }}" placeholder="e.g. ক্যাশ অন ডেলিভারি" required />
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="key" id="key" class="form-control @error('key') is-invalid @enderror"
                               value="{{ old('key', $paymentMethod->key) }}" placeholder="e.g. cod, bkash, nagad" required />
                        @error('key')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="col-12 mb-3">
                        <label for="description" class="form-label">Description</label>
                        <textarea name="description" id="description" rows="2" class="form-control"
                                  placeholder="Short description shown to the customer">{{ old('description', $paymentMethod->description) }}</textarea>
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="d-flex gap-3 mt-1">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="requires_transaction" value="1"
                                       {{ old('requires_transaction', $paymentMethod->requires_transaction ? '1' : '0') == '1' ? 'checked' : '' }}>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="requires_transaction" value="0"
                                       {{ old('requires_transaction', $paymentMethod->requires_transaction ? '1' : '0') == '0' ? 'checked' : '' }}>
                                <label class="form-check-label">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="payment_number" id="payment_number" class="form-control"
                               value="{{ old('payment_number', $paymentMethod->payment_number) }}" placeholder="e.g. 01700000000" />
                    </div>
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="icon" id="icon" class="form-control"
                               value="{{ old('icon', $paymentMethod->icon) }}" placeholder="banknotes" />
                    </div>
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="d-flex gap-3 mt-1">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="is_active" value="0"
                                       {{ old('is_active', $paymentMethod->is_active ? '1' : '0') == '0' ? 'checked' : '' }}>
                ...
                <div class="d-flex gap-2">
                    <button type="submit" class="btn btn-primary"><i class="ti ti-check me-1"></i> Update Method</button>
